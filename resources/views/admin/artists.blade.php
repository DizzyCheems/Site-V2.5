            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            @if($artist->image)
                                <img src="{{ asset('artist-profile-images/' . $artist->image) }}" class="artist-thumb" onerror="this.style.display='none'">
                            @else
                                <span style="color:#aaa;">—</span>
                            @endif
                        </td>
                        <td>
                            @if($artist->background_img)
                                <img src="{{ asset('artist-profile-images/' . $artist->background_img) }}" class="bg-thumb" onerror="this.style.display='none'">
                            @else
                                <span style="color:#aaa;">—</span>
                            @endif
                        </td>
                    ...
                    @empty
                    <tr><td colspan="7" style="text-align:center; color:#aaa; padding:40px;">No artists found. Click "Add Artist" to get started!</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
