...
@include('layouts.musiclibrary')
    ...
    <link rel="stylesheet" href="/succesor/assets/css/cardplayer.css" type="text/css">
...
@yield('musiclist')
  ...
  <script src="/succesor/assets/js/cardplayer.js"></script>
